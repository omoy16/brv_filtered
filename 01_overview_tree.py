...
tree_clf = DecisionTreeClassifier(
    max_depth=3, min_samples_leaf=10, random_state=42, class_weight="balanced"
)
...
perm_importance = permutation_importance(
    tree_clf, X_test, y_test, n_repeats=10, random_state=42
)
...
prob_summary = (
    pd.DataFrame({"Predicted_Prob": y_proba, "Actual_Win": y_test.values})
